...
class AmphibianViewModel : ViewModel() {
    ...
    val status: MutableLiveData<AmphibianApiStatus> get() = _status
    ...
    val amphibians: MutableLiveData<List<Amphibian>> get() = _amphibians

    // Create properties to represent MutableLiveData and LiveData for a single amphibian object.
    //  This will be used to display the details of an amphibian when a list item is clicked
    private val _amphibian = MutableLiveData<Amphibian>()
    val amphibian: MutableLiveData<Amphibian> get() = _amphibian
